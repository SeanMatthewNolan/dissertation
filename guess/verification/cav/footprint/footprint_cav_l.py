...
from giuseppe import SymPenaltyConstraintHandler
...
for h0, v0 in itertools.product(np.linspace(20e3, 180e3, steps), np.linspace(1e3, 25e3, steps)):
    ...
    guess = auto_propagate_guess(sym_ocp, control=(7.5 / 180 * 3.14159, 0), t_span=10, k=k)
...
with open('cav_l_data.data', 'wb') as file:
