...
fig1 = plt.figure(figsize=(6, 5.75))
fig1.suptitle('Comparison Between Guess and Solution')

gs = gridspec.GridSpec(4, 2)

ax_h   = fig1.add_subplot(gs[0, 0])
ax_phi = fig1.add_subplot(gs[0, 1])
ax_the = fig1.add_subplot(gs[1, 0])
ax_v   = fig1.add_subplot(gs[1, 1])
ax_gam = fig1.add_subplot(gs[2, 0])
ax_psi = fig1.add_subplot(gs[2, 1])

# sub_gs = gs[2, :].subgridspec(1, 2)

ax_alpha = fig1.add_subplot(gs[3, 0])
ax_beta  = fig1.add_subplot(gs[3, 1])

fig2 = plt.figure(figsize=(6, 5.75))
fig2.suptitle('Fitting the Dual Variables to the Guess')

ax_lam_h   = fig2.add_subplot(gs[0, 0])
ax_lam_phi = fig2.add_subplot(gs[0, 1])
ax_lam_the = fig2.add_subplot(gs[1, 0])
ax_lam_v   = fig2.add_subplot(gs[1, 1])
ax_lam_gam = fig2.add_subplot(gs[2, 0])
ax_lam_psi = fig2.add_subplot(gs[2, 1])

ax_ham   = fig2.add_subplot(gs[3, 0])
...
fig2.legend(handles, labels, ncols=1,  bbox_to_anchor=gs[3, 1].get_position(fig2), loc='right')
