...
guess = load_sol('downrange_unconstrained.bin')
# guess.k = sym_ocp.default_values
guess.nuf = np.concatenate((guess.nuf, (1.,)))
guess.annotations = sym_ocp.annotations
guess = match_constants_to_boundary_conditions(comp_prob, guess)

cont = ContinuationHandler(num_solver, guess)
cont.add_linear_series_until_failure({'v_f': 100})
sol_set = cont.run_continuation()

sol_set.save('max_phi.bin')
