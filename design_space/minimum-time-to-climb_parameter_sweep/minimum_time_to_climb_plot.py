...
from minimum_time_to_climb_isp_sweep import S, adiff_dual
...
if DATA == 0:
    ...
    with open('isp_series.data', 'rb') as file:
        sols = pickle.load(file)
        sol = sols[0]
...
# psi_0 = np.asarray(adiff_dual.compute_initial_boundary_conditions(
