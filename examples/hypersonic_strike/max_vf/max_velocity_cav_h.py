...
num_solver = SciPySolver(sym_ocp)

# from sympy import pprint
#
# pprint(sym_ocp.control_handler.control_dynamics[1], use_unicode=True, wrap_line=False)

guess = auto_propagate_guess(sym_ocp, control=(5 / 180 * 3.14159, 0), t_span=25)
