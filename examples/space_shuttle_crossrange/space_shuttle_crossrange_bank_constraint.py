...
from giuseppe.problems.symbolic import SymDual, PenaltyConstraintHandler, ControlConstraintHandler
...
ocp.add_inequality_constraint('path', 'beta', lower_limit='beta_min', upper_limit='beta_max',
                              regularizer=ControlConstraintHandler('eps_beta', method='atan'))
...
cont.add_linear_series(40, {'beta_min': -70 / 180 * 3.14159, 'beta_max': 70 / 180 * 3.14159})
cont.add_logarithmic_series(20, {'eps_beta': 2e-7})
sol_set = cont.run_continuation()

sol_set.save('crossrange_bank_constraint.data')
