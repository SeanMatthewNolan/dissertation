...
ocp.set_cost('0', '0', '-phi * (1 - xi) - theta  * xi')
...
cont_cross = ContinuationHandler(solver, sol_set[-1])
cont_cross.add_linear_series(100, {'xi': 1})
sol_set_cont = cont_cross.run_continuation()

sol_set_cont.save('crossrange_continuation_linear.data')
