...
input_ocp.add_constant('k_omega', 0.1)
...
input_ocp.set_cost('0', 'p_11 + p_22 + k_omega/2 * omega**2', '0')
...
cont.add_linear_series(100, {'x_f': 1000, 'y_f': 0})
cont.add_linear_series(100, {'x_b': 500, 'y_b': 250})
cont.add_logarithmic_series(100, {'eps_omega': 1e-2})
# cont.add_logarithmic_series(2000, {'eps_omega': 1e-6})
sol_set = cont.run_continuation()

sol_set.save('sol_set_nav_smooth.bin')
