...
ocp.add_constant('k', 1e-6)

ocp.set_cost('0', '1/2 * k * alpha ** 2', '-phi')
...
with Timer('Setup Time: '):
    ...
    guess = auto_propagate_guess(comp_dual, control=(15/180*3.14159,), t_span=100)
...
# cont.add_linear_series_until_failure({'gamma_0': 0.25 / 180 * 3.14159})
cont.add_linear_series(100, {'gamma_0': 10 / 180 * 3.14159})
sol_set = cont.run_continuation()

sol_set.save('downrange_dif_mit.data')
