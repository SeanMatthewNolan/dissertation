...
ocp.add_constant('angle_scale', 30 / 180 * np.pi)
...
ocp.set_cost('0', '0', '-(phi * cos(xi) - theta  * sin(xi)) / angle_scale')
...
cont.add_logarithmic_series(90, {'eps_q': 1e-4})
cont.add_linear_series(250, {'q_max': 70})
cont.add_logarithmic_series(90, {'eps_q': 1e-3})
sol_set = cont.run_continuation()

cont = ContinuationHandler(solver, sol_set[-1])
cont.add_linear_series(200, {'eps_q': 1e-7})
sol_set = cont.run_continuation()

sol_set.save('eps_effect.data')
