...
ocp.add_inequality_constraint('path', 'q', upper_limit='q_max', lower_limit='-q_max',
                              regularizer=PenaltyConstraintHandler('eps_q', method='sec'))
# ocp.add_inequality_constraint('path', 'q / q_max', upper_limit='1',
...
cont.add_linear_series(250, {'q_max': 70})
cont.add_logarithmic_series(90, {'eps_q': 1e-3})
sol_set = cont.run_continuation()

cont = ContinuationHandler(solver, sol_set[-1])
cont.add_linear_series(200, {'eps_q': 1e-5})
cont.add_logarithmic_series(200, {'eps_q': 1e-9})
sol_set = cont.run_continuation()

sol_set.save('eps_effect_sec.data')
