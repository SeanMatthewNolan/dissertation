...
cont.add_logarithmic_series(90, {'eps_beta': 1e-9, 'eps_q': 0.5e-5})
cont.add_linear_series(250, {'q_max': 150})
sol_set = cont.run_continuation()

cont = ContinuationHandler(solver, sol_set[-1])
cont.add_linear_series(500, {'q_max': 25})
sol_set = cont.run_continuation()

sol_set.save('heat_rate.data')
